<?php
 namespace test {include_once "DAO.php";class DataService {static function update($values) {$DAO = self::getObject();return $DAO->update($values);}
        ...
        private static function getObject() {return new\test\DAO();}
    }
}